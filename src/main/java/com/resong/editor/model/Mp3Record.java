...
/**
 * Class representing an MP3 file in the program; child class of Record.
 * Methods include those that establish its properties so as to allow JavaFX binding,
 * particularly when binding fields to specific columns in the TableView of the windows.
 * 
 * @author Rebecca Song
 */
public class Mp3Record extends Record {
    ...
    public Mp3Record(String location, String title, String artist, String album, String genre, String year, int duration) {
        super(location);
        setArtist(artist);
        setTitle(title);
        setAlbum(album);
    ...
    public Mp3Record(String location, String title, String artist, String album, String genre, String year, String length) {
        super(location);
        setArtist(artist);
        setTitle(title);
        setAlbum(album);
